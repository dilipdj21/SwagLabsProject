...
public class ExtentReporter {
	...
	public static ExtentReports generateExtentReport() {
		...
		sparkReporter.config().setReportName("SauceDemo Test Automation Results Report");
		sparkReporter.config().setDocumentTitle("SauceDemo Automation Report");
		sparkReporter.config().setTimeStampFormat("dd/MM/yyyy hh:mm:ss");
		extentReport.attachReporter(sparkReporter);

		Properties configProp = new Properties();
		File configPropFile = new File(System.getProperty("user.dir") + "/src/main/java/com/saucedemo/qa/config/config.properties");
		try {
